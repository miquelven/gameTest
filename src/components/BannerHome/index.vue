...
<template>
  <section
    class="flex flex-col justify-center gap-40 h-[calc(100vh-212px)] items-center my-28 max-xl:gap-32 max-lg:gap-48 max-sm:my-16 max-sm:h-[calc(100vh-244px)] max-sm:gap-32"
    id="container"
  >
