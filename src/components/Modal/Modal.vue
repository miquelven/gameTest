...
<template>
  ...
  >
    <div
      class="absolute left-[calc(50%-350px)] top-[calc(50%-210px)] h-[580px] w-[700px] bg-white overflow-y-auto text-black p-10 z-50 max-md:w-[500px] max-md:left-[calc(50%-250px)] max-[550px]:w-[250px] max-[550px]:left-[calc(50%-125px)] max-[550px]:p-3"
    >
      <template v-if="text == 'privacity'">
        <h2 class="text-3xl mb-10">Política Privacidade</h2>
        <p>
          A sua privacidade é importante para nós. É política do GamesTest
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site
          <a href="http//gametest.com.br">GamesTest</a>, e outros sites que
        ...
        <h3 class="mt-10">Compromisso do Usuário</h3>
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o GamesTest oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul class="my-10">
          <li>
          ...
          <li>
            ...
            (softwares) do GamesTest, de seus fornecedores ou terceiros, para
        ...
        <p class="mt-10">
          Esta política é efetiva a partir de&nbsp;24 January 2024 16:36
        </p>
      </template>
      <template v-else>
        <h2 class="my-5 text-2xl">1. Termos</h2>
        <p>
          Ao acessar ao site <a href="http//gametest.com.br">GamesTest</a>,
        ...
        <h2 class="my-5 text-2xl">2. Uso de Licença</h2>
        <p>
          É concedida permissão para baixar temporariamente uma cópia dos
          materiais (informações ou software) no site GamesTest , apenas para
        ...
        <ol class="my-5">
          <li>modificar ou copiar os materiais;&nbsp</li>
          <li>
            usar os materiais para qualquer finalidade comercial ou para
            exibição pública (comercial ou não comercial);&nbsp
          </li>
          <li>
            tentar descompilar ou fazer engenharia reversa de qualquer software
            contido no site GamesTest;&nbsp
          </li>
          <li>
            remover quaisquer direitos autorais ou outras notações de
            propriedade dos materiais; ou&nbsp
          </li>
          <li>
        ...
        <p>
          ...
          dessas restrições e poderá ser rescindida por GamesTest a qualquer
        ...
        <h2 class="my-5 text-2xl">3. Isenção de responsabilidade</h2>
        <ol>
          <li>
            Os materiais no site da GamesTest são fornecidos 'como estão'.
            GamesTest não oferece garantias, expressas ou implícitas, e, por
          ...
          <li>
            Além disso, o GamesTest não garante ou faz qualquer representação
        ...
        <h2 class="my-5 text-2xl">4. Limitações</h2>
        <p>
          Em nenhum caso o GamesTest ou seus fornecedores serão responsáveis
          ...
          uso ou da incapacidade de usar os materiais em GamesTest, mesmo que
          GamesTest ou um representante autorizado da GamesTest tenha sido
        ...
        <h2 class="my-5 text-2xl">5. Precisão dos materiais</h2>
        <p>
          Os materiais exibidos no site da GamesTest podem incluir erros
          técnicos, tipográficos ou fotográficos. GamesTest não garante que
          qualquer material em seu site seja preciso, completo ou atual.
          GamesTest pode fazer alterações nos materiais contidos em seu site a
          qualquer momento, sem aviso prévio. No entanto, GamesTest não se
          compromete a atualizar os materiais.
        </p>
        <h2 class="my-5 text-2xl">6. Links</h2>
        <p>
          O GamesTest não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por GamesTest do site. O uso de
          qualquer site vinculado é por conta e risco do usuário.
        </p>
        <p><br /></p>
        <h3 class="my-5 text-xl">Modificações</h3>
        <p>
          O GamesTest pode revisar estes termos de serviço do site a qualquer
          momento, sem aviso prévio. Ao usar este site, você concorda em ficar
          vinculado à versão atual desses termos de serviço.
        </p>
        <h3 class="my-5 text-xl">Lei aplicável</h3>
        <p>
          Estes termos e condições são regidos e interpretados de acordo com as
          leis do GamesTest e você se submete irrevogavelmente à jurisdição
          exclusiva dos tribunais naquele estado ou localidade.
        </p>
      </template>
      <button
        class="absolute bg-red-400 w-6 h-6 z-50 inset-0 text-white font-bold cursor-pointer"
